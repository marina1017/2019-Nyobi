...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.availability-toggle-button').each(function (i, e) {
  ...
  button.click(function () {
    ...
    var availability = parseInt(button.data('availability')); // 0 → 1 → 2 → 0 → 1 → 2 と循環させたいため、 ここでは 1 を足して 3 の剰余を次の出欠の数値

    var nextAvailability = (availability + 1) % 3; // 出欠更新の Web API の呼び出しと、実行結果を受け取って button 要素の、 data-* 属性を更新し、ボタンのラベルを更新しています。
